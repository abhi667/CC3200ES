...
linker.cmd: package/cfg/subscribe_publish_sample_pem4.xdl
	$(SED) 's"^\"\(package/cfg/subscribe_publish_sample_pem4cfg.cmd\)\"$""\"C:/AWS_CC3200ES3_Publish_Subscribe/Debug/configPkg/\1\""' package/cfg/subscribe_publish_sample_pem4.xdl > $@
